...
const btnActivated = $('.btn-notification-activated');
const btnDeactivated = $('.btn-notification-deactivated');
...
//   console.log(activated);
  ...
  if (activated) {
    ...
    btnDeactivated.addClass('hidden');
    return;
  }
  //else

  btnDeactivated.removeClass('hidden');
...
btnActivated.on('click', cancelSubscription);